...
import { CircleMinus, CirclePlus, StepForward } from "lucide-react";
    ...
    <div className="mx-auto font-poppins">
      ...
      >
        ...
        <section className="flex gap-1 ">
          ...
          <Link to={"/cartpage"}>
            <button style={filterstyling} className="flex">
              Cart
            </button>
          </Link>
        </section>
      ...
      >
        ...
        <p>Tax estimate(8%) : ₹{Math.round(Taxestimate)}</p>
        <p>Total Amount : ₹{totalAmountwithtax}</p>
        <button
